        ...
        <div className="grid gap-5 md:grid-cols-2">
          {projects.map((project, index) => (
            <AnimatedSection key={index} delay={index * 0.1}>
              <div className="group h-full rounded-lg border border-border bg-surface overflow-hidden hover:border-accent/30 hover:shadow-lg hover:shadow-accent/5 transition-all duration-300">
                {/* Editor title bar */}
                ...
                <div className="relative h-40 bg-surface-light/50 flex items-center justify-center overflow-hidden border-b border-border">
                  <div className="font-mono text-xs text-border/60 group-hover:text-accent/30 transition-colors duration-500 text-center px-4">
                    <span className="text-3xl font-bold block mb-1 group-hover:scale-110 transition-transform duration-500">
                ...
                <div className="p-5">
                  <h3 className="text-base font-semibold mb-2 group-hover:text-accent transition-colors">{project.title}</h3>
